...
export const useOwnedNFTs = (lastNFTMintedId, nftContract, marketplaceContract, userWalletAddress, refreshOwnedNFTs) => {
    ...
    }, [nftContract, marketplaceContract, userWalletAddress, lastNFTMintedId, refreshOwnedNFTs]);
