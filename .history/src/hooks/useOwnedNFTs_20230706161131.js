...
export const useOwnedNFTs = (lastNFTMintedId, nftContract, marketplaceContract, userWalletAddress, refreshOwnedNFTs, txConfirm) => {
    ...
    }, [nftContract, marketplaceContract, userWalletAddress, lastNFTMintedId, refreshOwnedNFTs, txConfirm]);
