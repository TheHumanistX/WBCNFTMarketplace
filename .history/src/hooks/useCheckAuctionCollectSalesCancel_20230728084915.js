        ...
        const checkAuctionCollectSalesCancel = async () => {
            ...
            for (const listing of listingData) {
                ...
                if (currentOwner === userWalletAddress) {
                    ...
                    } else if (listing.listingType === 2 && currentStatus === 3 && (await marketplaceContract.getAuction(listing.listingId)).topBidder === userWalletAddress) {
            ...
            if (usersExpiredAuctions.includes(listing.listingId)) {
                usersExpiredAuctions.splice(usersExpiredAuctions.indexOf(listing.listingId), 1);
            }
