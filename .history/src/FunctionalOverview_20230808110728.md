...
- This utility function simple handles the approval process for listing an NFT from the selected nft collection on the marketplace.  It either returns the approval or `null` (if there is an error). 
