...
const ViewAuctions = () => {
  ...
  useEffect(() => {
    ...
    const fetchEvents = async () => {
      ...
      const minBidIncrements = auctionDetails.map(auctionDetail => auctionDetail[4].toNumber());  // Assuming minBidIncrement is at index 4 of the returned tuple
      const currentBids = auctionDetails.map(auctionDetail => auctionDetail[3].toNumber());  // Assuming currentBid is at index 4 of the returned tuple
