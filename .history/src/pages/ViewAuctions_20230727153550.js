...
const ViewAuctions = () => {
  ...
  const bidWithETH = useCallback(async (bidAmount, auctionID, formattedMinBidIncrement) => {
    ...
    console.log('bidWithETH formattedMinBidIncrement: ', formattedMinBidIncrement)
    console.log('bidWithETH parseFloat(bidAmount) + parseFloat(formattedMinBidIncrement): ', parseFloat(bidAmount) + parseFloat(formattedMinBidIncrement))
