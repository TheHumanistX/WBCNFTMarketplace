  ...
  useEffect(() => {
    ...
    const fetchEvents = async () => {
      ...
      const currentListings = marketplaceNFTListedEvents.map((event) => ({
        ...
        paymentMethodSymbol: event.data.paymentContract === '0x0000000000000000000000000000000000000000' ? 'ETH' : 'WBC',
          ...
          return (
            <div key={index} className='listing-flex'>
              ...
              <button className='buynft__button' onClick={() =>
                listing.paymentContractAddress === '0x0000000000000000000000000000000000000000'
                  ?
