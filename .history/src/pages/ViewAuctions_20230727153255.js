...
const ViewAuctions = () => {
  ...
  const bidWithETH = useCallback(async (bidAmount, auctionID, minBidIncrement) => {
    console.log('bidWithETH parseFloat(bidAmount): ', parseFloat(bidAmount))
    console.log('bidWithETH minBidIncrement: ', minBidIncrement)
    console.log('bidWithETH parseFloat(bidAmount) + minBidIncrement: ', parseFloat(bidAmount) + minBidIncrement)
    ...
    if (!await bidOnAuctionInputChecks(bidAmount, minBidIncrement, setIsOpen, setModalText)) return;
