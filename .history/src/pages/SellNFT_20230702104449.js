...
//       const numberOfItems = Math.max(marketplaceNFTListedEvents.length, lastNFTMintedId);
//       const numberOfTotalListings = marketplaceNFTListedEvents.length;
//       console.log('numberOfItems: ', numberOfItems)
//       for (let i = 1; i <= numberOfItems; i++) {
//         const itemType = await marketplaceContract.call("getItemType", [i]);
//         console.log('itemType, iteration (', i, ') : ', itemType)
//         if (itemType === "LISTING") {
//           const listing = await marketplaceContract.call("getListing", [i]);
//           console.log('listing: ', listing)
//           if (listing.owner.toLowerCase() === userWalletAddress.toLowerCase() && listing.status !== "ACTIVE") {
