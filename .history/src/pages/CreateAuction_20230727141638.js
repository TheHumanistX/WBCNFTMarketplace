...
const CreateAuction = () => {
    ...
    const handleCreateAuction = async (auctionDetails) => {
        ...
        if (isNaN(auctionDetails.initialBidAmount) || auctionDetails.initialBidAmount === '') {
            setIsOpen(true);
            setModalText('Please enter a valid initial bid amount.');
            return;
        }
        if (isNaN(auctionDetails.bidIncrement) || auctionDetails.bidIncrement === '') {
            setIsOpen(true);
        ...
        try {
            ...
            setIsOpen(true);
            setModalText('Failed to approve NFT transfer...');
            return;
        }
