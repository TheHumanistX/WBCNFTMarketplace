...
- We declare the `spendWithWBC` function which calls the [`approveTokenSpend`](#approveTokenSpend) utility function.
  - We then move on, assuming no errors, to call the [`tokenSpend`](#tokenSpend) utility function to 
