    ...
    useEffect(() => {
        ...
        window.ethereum.on('accountsChanged', async (accounts) => {
            if (accounts.length === 0) {
                ...
                console.log('EthersContext accountsChanged accounts: ', accounts)
                console.log('EthersContext accountsChanged accounts[0]: ', accounts[0])
                console.log('EthersContext accountsChanged userWalletAddress: ', userWalletAddress)
                const provider = new ethers.providers.Web3Provider(window.ethereum);
