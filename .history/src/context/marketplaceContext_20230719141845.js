...
import { TOKEN_CONTRACT_ADDRESS, ETHEREUM_NULL_ADDRESS, MARKETPLACE_CONTRACT_ADDRESS } from "../constants";
...
export const MarketplaceContextProvider = ({ children }) => {
  ...
  const marketplaceContractAddress = '0x9D36785bBc134ff69a999E5A2676d2542eBBDeAa';
