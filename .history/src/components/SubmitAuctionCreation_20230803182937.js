    ...
    return (
        <>
            <form onSubmit={handleSubmit} className='owned-nft__sale-form'>
                ...
                <label htmlFor='initialBidAmount'>
                    Starting Bid Amount:
                </label>
                <input
                    type='text'
                ...
                />
                <label htmlFor='auctionBeginTime'>
                    Auction Begin Time:
                </label>
                <input
                    type='datetime-local'
                    id='auctionBeginTime'
                    value={auctionBeginTime}
                    onChange={e => setAuctionBeginTime(e.target.value)}
                    placeholder='Auction Begin Time'
                />
