...
const ShowListedNFTs = ({ listing, buyWithETH, buyWithWBC, bidWithETH, bidWithWBC, setTimerComplete }) => {
            ...
            {path === '/buy_nft' ? (
                ...
                <div className='showListedNFT__container'>
                    ...
                    <div>
                            ...
                            <span>Time Remaining: <TimeRemaining expiration={currentListing.expiration} timerComplete={timerComplete} setTimerComplete={setTimerComplete} /></span>
                            <span>Sold By: {currentListing.owner}</span>
                            <BidOnNFT
