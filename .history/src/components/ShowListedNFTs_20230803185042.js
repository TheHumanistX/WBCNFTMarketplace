...
const NFTMeta = ({ nftData, nftContract, currentListing }) => (
    <div className='nft-listing__meta'>
        <span className='last-minted__name'>
            <a href={`https://testnets.opensea.io/assets/goerli/${nftContract}/${currentListing.tokenId}`}>
                {nftData.name}
            </a>
        </span>
                ...
                <div className='showListedNFT__container'>
                    ...
                    <div className='nft-listing__data buy'>
                        ...
                        <div className='nft-listing__data-row2 buy'>
                            ...
                            <span>
                                <a href={`https://goerli.etherscan.io/address/${currentListing.owner}`}>
                                    {listingOwner}
                                </a>
                            </span>
                        </div>
                ...
                <div className='showListedNFT__container'>
                    ...
                    <div className='nft-listing__data'>
                        ...
                        <div className='nft-listing__data-row2'>
                            ...
                            <span>
                                {currentListing.formattedExpiration}
                            </span>
                        </div>
                        <div className='nft-listing__data-row3'>
                            ...
                            <span>
                                <TimeRemaining
                                    expiration={currentListing.expiration}
