        ...
        <div className='listed-nft__flex'>
            ...
            {path === '/view_auctions' && nftData &&
                <div className='showListedNFT__container'>
                    ...
                    <span>Sold By: {currentListing.owner}</span>
                    {/* <BidOnNFTPayment bidWithETH={bidWithETH} bidWithWBC={bidWithWBC} auctionID={currentListing.auctionID} price={currentListing.price} tokenSymbol={tokenSymbol} paymentContractAddress={currentListing.paymentContractAddress} /> */}
