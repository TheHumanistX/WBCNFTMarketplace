        ...
        <div className='listed-nft__flex'>
            ...
            {path === '/buy_nft' && nftData &&
                <>
                    ...
                    <ListedSales listingID={listingID} owner={owner} nftPrice={nftPrice} tokenID={tokenID} nftData={nftData} tokenSymbol={tokenSymbol} paymentContractAddress={paymentContractAddress} nftContractName={nftContractName} />
