...
const SellNFT = () => {
  ...
  const crazyFacesContractAddress = '0xBC4CA0EdA7647A8aB7C2061c2E118A18a936f13D';
  ...
  return (
    <section className='sellNFT__container'>
      ...
      <span>You currently hold { userNFTBalance ? userNFTBalance.toNumber() : '' } NFTs from the { contractName ? contractName : '' } contract.</span>
    </section>
  )
}
