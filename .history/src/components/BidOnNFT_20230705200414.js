...
const BidOnNFT = ({ bidWithETH, bidWithWBC, auctionID, minBidIncrement, formattedMinBidIncrement, tokenSymbol, paymentContractAddress }) => {
  ...
  return (
    <div>
      ...
      <input type='number' id='bidAmount' name='bidAmount' placeholder={`Must Be At Least ${formattedMinBidIncrement} ${tokenSymbol}`} onChange={(e) => setBidAmount(e.target.value)} />
