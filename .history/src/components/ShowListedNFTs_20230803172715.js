...
const ShowListedNFTs = ({ listing, buyWithETH, buyWithWBC, bidWithETH, bidWithWBC, timerComplete, setTimerComplete }) => {
    ...
    const listingOwner = currentListing.owner.slice(0,5) + '...' + currentListing.owner.slice(-4, 0);
    useEffect(() => {
            ...
            {path === '/buy_nft' ? (
                ...
                <div className='showListedNFT__container'>
                    ...
                    <div className='nft-listing__data'>
                        ...
                        <span>Sold By: <a href={`https://goerli.etherscan.io/address/${currentListing.owner}`}>{listingOwner}</a></span>
                        <BidOnNFT
