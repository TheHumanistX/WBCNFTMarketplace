...
const SellNFT = () => {
  const { marketplaceContractAddress, marketplaceContract, nftContractAddress, nftContract, nftContractName, setNFTContractAddress, ownedNFTs, setOwnedNFTs, userNFTBalance, userWalletAddress } = useContext(MarketplaceContext);
