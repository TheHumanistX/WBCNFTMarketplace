        ...
        <div className='listed-nft__flex'>
            ...
            {path === '/view_auctions' && nftData &&
                <div className='showListedNFT__container'>
                    ...
                    <span>Sold By: {currentListing.owner}</span>
                    <BidOnNFT bidWithETH={bidWithETH} bidWithWBC={bidWithWBC} auctionID={currentListing.auctionID} minBidIncrement={currentListing.minBidIncrement} formattedInitialBid={currentListing.formattedInitialBid} formattedMinBidIncrement={currentListing.formattedMinBidIncrement} tokenSymbol={tokenSymbol} paymentContractAddress={currentListing.paymentContractAddress} />
