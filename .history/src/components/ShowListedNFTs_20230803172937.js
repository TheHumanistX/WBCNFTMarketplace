...
const ShowListedNFTs = ({ listing, buyWithETH, buyWithWBC, bidWithETH, bidWithWBC, timerComplete, setTimerComplete }) => {
    ...
    const listingOwner = currentListing.owner.slice(0, 5) + '...' + currentListing.owner.slice(-4);
    useEffect(() => {
                ...
                <div className='showListedNFT__container'>
                    ...
                    <div className='nft-listing__data'>
                        ...
                        <div className='nft-listing__data-row4'>
                            <span>Sold By:</span> <span><a href={`https://goerli.etherscan.io/address/${currentListing.owner}`}>{currentListing.owner}</a></span>
                        </div>
                        <BidOnNFT
