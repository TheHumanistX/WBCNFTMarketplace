    ...
    <div>
      {paymentContractAddress === ETHEREUM_NULL_ADDRESS ?
        <div>
          ...
          <input type='number' id='bidAmount' name='bidAmount' placeholder={`Must Be At Least ${minBidAmount} ${tokenSymbol}`} value={bidAmount} onChange={(e) => setBidAmount(e.target.value)} />
