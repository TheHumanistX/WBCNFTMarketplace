...
const SellNFT = () => {
  const { approveNFTTransfer, createListing, marketplaceContractAddress, marketplaceContract, nftContractAddress, nftContract, nftContractName, setNFTContractAddress, ownedNFTs, setOwnedNFTs, userNFTBalance, userWalletAddress } = useContext(MarketplaceContext);
