...
const MarqueeScroller = () => {
  return (
    <div className='marqueeScroller__nft-gifs'>
      <Marquee direction="left" speed={100} delay={0} gradient={true}>
        ...
        <img src='https://i.seadn.io/gae/Iko3YkHKgmvi5HVP_bjxOytEyvFOp-D4lLl7YecZfkOb4hva9Mdchb--H88l-tdxZSAjmT7406RtSPY5DN83nqBEOAjrnPzxYinC' alt='NFT Collection Gif' />
