...
const ShowListedNFTs = ({ listing, marketplaceContract, buyWithETH, buyWithWBC, bidWithETH, bidWithWBC }) => {
    ...
    const { contract: tokenContract } = useContract(currentListing.paymentContractAddress === ETHEREUM_NULL_ADDRESS ? 'ETH' : currentListing.paymentContractAddress);
        ...
        <div className='listed-nft__flex'>
            ...
            {path === '/view_auctions' && nftData &&
                <div className='showListedNFT__container'>
                    ...
                    <span>Sold By: {currentListing.owner}</span>
                    <BidOnNFT bidWithETH={bidWithETH} bidWithWBC={bidWithWBC} auctionID={currentListing.auctionID} minBidIncrement={currentListing.minBidIncrement} formattedMinBidIncrement={currentListing.formattedMinBidIncrement} tokenSymbol={tokenSymbol} paymentContractAddress={currentListing.paymentContractAddress} />
