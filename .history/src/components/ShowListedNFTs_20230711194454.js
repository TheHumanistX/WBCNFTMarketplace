...
const ShowListedNFTs = ({ listing, marketplaceContract, buyWithETH, buyWithWBC, bidWithETH, bidWithWBC }) => {
    ...
    console.log('ShowListedNFTs nft:', nft)
        ...
        <>
            ...
            {path === '/buy_nft' && nftData &&
                <div className='showListedNFT__container'>
                    ...
                    <a href={`https://testnets.opensea.io/assets/goerli/${nft}/` + (currentListing.tokenId)}><img src={`https://ipfs.io/ipfs/${nftData.image.split('ipfs://')[1]}`} alt={nftData.name} className='listed-nfts' /></a>
