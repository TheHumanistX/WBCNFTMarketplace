...
const BidOnNFT = ({ bidWithETH, bidWithWBC, auctionID, minBidIncrement, formattedInitialBid, formattedMinBidIncrement, tokenSymbol, paymentContractAddress }) => {
    const {
  ...
  return (
    <div>
      ...
      <input type='number' id='bidAmount' name='bidAmount' placeholder={`Must Be At Least ${formattedInitialBid + formattedMinBidIncrement} ${tokenSymbol}`} onChange={(e) => setBidAmount(e.target.value)} />
